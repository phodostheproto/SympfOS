...
const uint64_t RECTS[] PROGMEM = {
  ...
  0x000000f0f0000000,  //Dash1
  0x0000000f0f000000,  //Dash2
  0x000000fcfc000000,  //Dash3 LONG DASHp1
  0x0000003f3f000000,  //Dash4 LONG DASHp2
};

//Text stuffs
const uint64_t TEXT[] PROGMEM = {
  0x0000000000000000,  //Space0
  0xc3e77e3c3c7ee7c3,  //X1
  0xffffc0ffffc0ffff,  //E2
  0x7effc0cfcfc3ff7e,  //G3
  0xc3c3c3663c181818,  //Y4
  0x183c6666ffe7c381,  //A5
  0xffffc0ffff03ffff,  //S6
  0xc3e7ffffffdbdbc3,  //M7
  0xfeffc3ffffc3fffe,  //B8
  0xffff18181818ffff,  //I9
};

//ANIMATION NEEDS TO BE IN RAM NOT PROGMEM
const uint64_t CONFUSION[] = {
  //Confusion Animation
  0x00fe82baa2be80ff, //Swirloff1
  0xfe82baaaaaa2be80, //Swirloff2
  0xff017d455d417f00, //Swirloff3
